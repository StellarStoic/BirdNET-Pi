...
?>
    ...
    <form id="advancedform" action="" method="GET">
      ...
      <p><small>Hosting on Tor will allow you to access your BirdNET-Pi from anywhere using <a href="https://www.torproject.org/download/" target="_blank"><span style="background-color: #4B0082">Tor Browser</span> 🧅</a>.</small></p>    <?php if (isset($newconfig['TOR_ONION']) && strlen($newconfig['TOR_ONION'])>0) { ?>
        <p>Onion address: 
      ...
      <div id="torStatus" style="display: none; color: #536881ff; font-weight: italic;">
        Tor operation in progress... Please wait (this may take up to 60 seconds) If you see no changes, please refresh the page.
      </div>
